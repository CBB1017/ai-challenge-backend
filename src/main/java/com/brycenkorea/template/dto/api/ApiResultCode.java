...
public enum ApiResultCode {
    ...
    NO_CONTENT(204, "콘텐트 없음", HttpStatus.NO_CONTENT),

    VALIDATION_ERROR(400, "올바른 데이터로 요청해 주세요.", HttpStatus.BAD_REQUEST),
    INVALID_TOKEN(400, "인증에 실패했습니다.", HttpStatus.BAD_REQUEST),
    INVALID_PARAMETER(400, "올바르지 않은 파라미터입니다.", HttpStatus.BAD_REQUEST),
    UNAUTHORIZED(401, "인증이 필요합니다.", HttpStatus.UNAUTHORIZED),
    FORBIDDEN(403, "권한이 없습니다.", HttpStatus.FORBIDDEN),
    MEMBER_NOT_FOUND(404, "사용자 없음", HttpStatus.OK),
    MEMBER_ALREADY_EXISTS(409, "이미 존재하는 사용자입니다.", HttpStatus.CONFLICT),

    INTERNAL_ERROR(500, "서버 오류입니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    SQL_SYNTAX_ERROR(501, "SQL 구문 오류가 발생했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
